			...
			<div className="mx-auto max-w-7xl">
				...
				>
					...
					<p className="mt-6 leading-relaxed text-muted-foreground lg:text-lg">
						...
						хипотетична бизнес персона на име Стефан Стефанов. Ще трябва да проучите и изберете
						инвестиции, които са съобразени с целите, ценностите и толерантността към риска на Стефан,
