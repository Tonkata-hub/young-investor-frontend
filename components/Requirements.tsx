		...
		<section id="requirements" className="bg-foreground px-6 py-24 text-background lg:px-8 lg:py-32">
			<div className="mx-auto max-w-7xl">
				...
				<div className="mt-16 grid gap-6 lg:mt-20 lg:grid-cols-2">
					<div className="rounded-2xl border border-background/10 bg-background/5 p-8 lg:p-10">
				...
				<div className="mt-6 rounded-2xl border border-background/10 bg-background/5 p-8 lg:p-10">
